// This code was autogenerated with `dbus-codegen-rust -s -d org.bluez -p /org/bluez/hci0 -f org.bluez.Adapter1`, see https://github.com/diwic/dbus-rs
...
pub trait OrgBluezAdapter1 {
    ...
    fn connectable(&self) -> Result<bool, dbus::Error>;
    fn set_connectable(&self, value: bool) -> Result<(), dbus::Error>;
