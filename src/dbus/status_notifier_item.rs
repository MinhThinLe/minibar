// This code was autogenerated with `dbus-codegen-rust -g -m None -p /StatusNotifierItem -f org.kde.StatusNotifierItem -d :1.25`, see https://github.com/diwic/dbus-rs
...
pub trait OrgKdeStatusNotifierItem {
    fn provide_xdg_activation_token(&self, token: &str) -> Result<(), dbus::Error>;
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target = T>> OrgKdeStatusNotifierItem
